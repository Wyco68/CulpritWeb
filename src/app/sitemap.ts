...
// Only the 7 public tabs are indexable content — admin, login, and API routes are deliberately
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${SITE_URL}/teaching`, lastModified, changeFrequency: 'monthly', priority: 0.7 },
